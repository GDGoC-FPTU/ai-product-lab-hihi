...
| # | Subsidiary (Công ty)   | Lens (Thấu kính)     | Mô tả ngắn bài toán / Bottleneck                                                                                                                                                                                             |
| - | ----------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 | **Xanh SM (GSM)** | Tốn thời gian        | Điều phối viên phải xử lý thủ công các báo cáo khẩn cấp từ tài xế về sự cố sạc pin hoặc hết pin giữa đường (mất 15-20 phút/lượt).                                                                  |
...
| 6 | **Xanh SM (GSM)** | Lặp lại              | Bộ phận đối soát tài chính phải tra cứu thủ công lịch sử định vị GPS và log chuyến đi để xác minh khiếu nại của khách hàng về việc tài xế đi sai lộ trình/tính sai tiền.                      |
...
## QUICK PROBLEM CARD #1: Vinhomes — Tự động phân loại và điều hướng phản ánh cư dân
...
## QUICK PROBLEM CARD #2: Xanh SM — Xử lý sự cố sạc pin thực địa của tài xế
...
## QUICK PROBLEM CARD #3: Vinmec — Tự động soạn thảo tóm tắt hồ sơ xuất viện
